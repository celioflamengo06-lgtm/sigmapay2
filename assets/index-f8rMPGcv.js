      ...
      if (G.success && G.status) {
        if (w(G.status), G.status === "paid") {
          ...
          return !localStorage.getItem(I) && typeof window.fbq < "u" && (window.fbq("track", "Purchase", {
            value: (t == null ? void 0 : t.amount) || 38.40,
            currency: "BRL",
      ...
      children: l.jsxs(bn, {
        ...
        children: [l.jsxs(ci, {
          ...
          children: [l.jsx("div", {
            ...
            children: [l.jsxs("p", {
              className: "text-3xl font-bold text-green-600",
              children: ["R$ ", ((P = t == null ? void 0 : t.amount) == null ? void 0 : P.toFixed(2).replace(".", ",")) || "38,40"]
            }), l.jsx("p", {
              className: "text-gray-600",
            ...
            children: [l.jsx("h4", {
              ...
              children: [l.jsx("li", {
                ...
                children: "4. Confirme o pagamento de R$ 38,40"
              })]
            })]
          }), l.jsxs("div", {
      ...
      if (Y.success && Y.status) {
        if (I(Y.status), Y.status === "paid") {
          if (console.log("PAGAMENTO CONFIRMADO!", Y.bank_tx_id), typeof window < "u" && window.fbq) {
            const ge = window.fbq;
            ge("track", "Purchase", {
              value: (m == null ? void 0 : m.amount) || 38.40,
              currency: "BRL",
              content_type: "product",
              content_ids: [B],
...
• Taxa de Expedição de Documento (TED): R$ 12,45
• Taxa de Serviços Administrativos (TSA): R$ 14,20
• Taxa de Processamento Eletrônico (TPE): R$ 11,75

Valor Total: R$ 38,40`, 3e3), i("finalize_button")
    }, ww = async () => {
...
Assim que realizar o pagamento das taxas no valor de R$ 38,40, clique no botão abaixo para ativar seu cadastro.`, !0), i("awaiting_payment")
    };
  x.useEffect(() => {
    f && y && fw()
  }, [f, y]);
