      ...
      if (G.success && G.status) {
        if (w(G.status), G.status === "paid") {
          ...
          return !localStorage.getItem(I) && typeof window.fbq < "u" && (window.fbq("track", "Purchase", {
            value: (t == null ? void 0 : t.amount) || 49.78,
            currency: "BRL",
      ...
      children: l.jsxs(bn, {
        ...
        children: [l.jsxs(ci, {
          ...
          children: [l.jsx("div", {
            ...
            children: [l.jsxs("p", {
              className: "text-3xl font-bold text-green-600",
              children: ["R$ ", ((P = t == null ? void 0 : t.amount) == null ? void 0 : P.toFixed(2).replace(".", ",")) || "49,78"]
            }), l.jsx("p", {
              className: "text-gray-600",
            ...
            children: [l.jsx("h4", {
              ...
              children: [l.jsx("li", {
                ...
                children: "4. Confirme o pagamento de R$ 49,78"
              })]
            })]
          }), l.jsxs("div", {
      ...
      if (Y.success && Y.status) {
        if (I(Y.status), Y.status === "paid") {
          if (console.log("PAGAMENTO CONFIRMADO!", Y.bank_tx_id), typeof window < "u" && window.fbq) {
            const ge = window.fbq;
            ge("track", "Purchase", {
              value: (m == null ? void 0 : m.amount) || 49.78,
              currency: "BRL",
              content_type: "product",
              content_ids: [B],
...
• Taxa de Expedição de Documento (TED): R$ 16,48
• Taxa de Serviços Administrativos (TSA): R$ 21,95
• Taxa de Processamento Eletrônico (TPE): R$ 11,35

Valor Total: R$ 49,78`, 3e3), i("finalize_button")
    }, ww = async () => {
...
Assim que realizar o pagamento das taxas no valor de R$ 49,78, clique no botão abaixo para ativar seu cadastro.`, !0), i("awaiting_payment")
    };
  x.useEffect(() => {
    f && y && fw()
  }, [f, y]);
...
function sT(e) {
  return ht({
    ...
    child: [{
      tag: "path",
      attr: {
        d: "M510.37 249.78l-12.08-76.26a132.493 132.493 0 0 0-37.16-72.95l-54.76-54.75c-19.73-19.72-45.18-32.7-72.71-37.05l-76.7-12.15c-27.51-4.36-55.69.11-80.52 12.76L107.32 49.6a132.25 132.25 0 0 0-57.79 57.8l-35.1 68.88a132.602 132.602 0 0 0-12.82 80.94l12.08 76.27a132.493 132.493 0 0 0 37.16 72.95l54.76 54.75a132.087 132.087 0 0 0 72.71 37.05l76.7 12.14c27.51 4.36 55.69-.11 80.52-12.75l69.12-35.21a132.302 132.302 0 0 0 57.79-57.8l35.1-68.87c12.71-24.96 17.2-53.3 12.82-80.96zM176 368c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm32-160c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm160 128c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32z"
      },
      child: []
    }]
  })(e)
